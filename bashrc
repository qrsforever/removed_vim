...
alias rm='rm -i'
alias minicom='cd /home/lidong/Templates; sudo minicom'
alias eclimd='cd /home/lidong/Templates; eclimd'
...
export PATH=$JAVA_HOME/bin:$ECLIPSE_HOME:$ANSDK_PATH/tools:$ANNDK_PATH:$PATH

xadb () {
    adb disconnect
    if [[ "$1"x != x ]]
    then
        adb connect 172.16.0.$1
    fi
    return $?
}
...
xgv () {
    ...
    vim -g -p -f --servername QRS --remote-tab-silent $argv
}
