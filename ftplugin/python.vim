" QRS: from /usr/local/share/vim/vim82/ftplugin/python.vim
"      [m -> [f
"
...
if !exists('g:no_plugin_maps') && !exists('g:no_python_maps')
    ...
    execute "nnoremap <silent> <buffer> ]f :call <SID>Python_jump('n', '". b:next."', 'W', v:count1)<cr>"
    execute "nnoremap <silent> <buffer> [f :call <SID>Python_jump('n', '". b:prev."', 'Wb', v:count1)<cr>"
    execute "nnoremap <silent> <buffer> ]F :call <SID>Python_jump('n', '". b:next_end."', 'W', v:count1, 0)<cr>"
    execute "nnoremap <silent> <buffer> [F :call <SID>Python_jump('n', '". b:prev_end."', 'Wb', v:count1, 0)<cr>"
    ...
    execute "onoremap <silent> <buffer> ]f :call <SID>Python_jump('o', '". b:next."', 'W', v:count1)<cr>"
    execute "onoremap <silent> <buffer> [f :call <SID>Python_jump('o', '". b:prev."', 'Wb', v:count1)<cr>"
    execute "onoremap <silent> <buffer> ]F :call <SID>Python_jump('o', '". b:next_end."', 'W', v:count1, 0)<cr>"
    execute "onoremap <silent> <buffer> [F :call <SID>Python_jump('o', '". b:prev_end."', 'Wb', v:count1, 0)<cr>"
    ...
    execute "xnoremap <silent> <buffer> ]f :call <SID>Python_jump('x', '". b:next."', 'W', v:count1)<cr>"
    execute "xnoremap <silent> <buffer> [f :call <SID>Python_jump('x', '". b:prev."', 'Wb', v:count1)<cr>"
    execute "xnoremap <silent> <buffer> ]F :call <SID>Python_jump('x', '". b:next_end."', 'W', v:count1, 0)<cr>"
    execute "xnoremap <silent> <buffer> [F :call <SID>Python_jump('x', '". b:prev_end."', 'Wb', v:count1, 0)<cr>"
endif
