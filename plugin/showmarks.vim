...
"lidong mod
hi default ShowMarksHLl ctermfg=blue ctermbg=none cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLu ctermfg=blue ctermbg=none cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLo ctermfg=blue ctermbg=none cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLm ctermfg=blue ctermbg=none cterm=bold guifg=blue guibg=lightblue gui=bold
"lidong end
