...
class Logcat(plugin.MenuItem):
    ...
    def __init__(self):
        ...
        # if os.path.exists('/tmp/.terminator_logcat.txt'):
        #     with open('/tmp/.terminator_logcat.txt', 'r') as f:
        #         self.last_open_dir = f.read()
    ...
    def start_logger(self, _widget, Terminal):
        ...
        savedialog.set_current_folder(self.last_open_dir)
        ...
        if response == Gtk.ResponseType.OK:
            try:
                ...
                self.last_open_dir = savedialog.get_current_folder()
                # with open('/tmp/.terminator_logcat.txt', 'w') as f:
                #     f.write(self.last_open_dir)
                logfile = os.path.join(self.last_open_dir, filename)
                fd = open(logfile, 'w+')
                # Save log file path, 
