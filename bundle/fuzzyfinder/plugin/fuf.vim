...
function s:initialize()
  ...
  " lidong add
  call l9#defineVariableDefault('g:fuf_keyOpenSplit'     , '<C-s>')
  ...
  call l9#defineVariableDefault('g:fuf_keyPreview'       , '<C-null>')
  call l9#defineVariableDefault('g:fuf_keyNextMode'      , '<C-null>')
  call l9#defineVariableDefault('g:fuf_keyPrevMode'      , '<C-null>')
  call l9#defineVariableDefault('g:fuf_keyPrevPattern'   , '<C-null>')
  call l9#defineVariableDefault('g:fuf_keyNextPattern'   , '<C-null>')
  " lidong end
