...
"lidong add 
"如果存在:Segments/tagbar.vim, 则可以不需要
"上面currenttag currentascii projectname"
"
"\ Pl#Segment#Create('projectname'     , '%{eclim#project#util#ProjectStatusLine()} %', Pl#Segment#Modes('!N')),
"lidong end
